...
public class NotificationServiceTest {
	...
	void sendNotificationByEmailTriggerManual() {
		...
		notificationService.sendActivationCardEmail("witsanu.t@tsc.com",ProductsExpServiceConstant.HEADER_CORRELATION_ID, "TMB Touch",
				"ทีเอ็มบี ทัซ", "0000000050079650011000193", "Product Test En", "ผลิตภัณฑ์ 1");
	}

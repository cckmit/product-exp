...
public class InstallmentRateControllerTest {
	...
	@Mock
	CashForUService cashForUService;
	@InjectMocks
	...
	public void testGetLoanAccountDetail() {
		...
		ResponseEntity<TmbOneServiceResponse<InstallmentRateResponse>> response = new ResponseEntity<>(serverResponse,
				HttpStatus.OK);
	...
	public void testTestGetLoanAccountDetail() {
		...
		installmentRateResponseTmbOneServiceResponse
				.setStatus(new TmbStatus("code", "message", "service", "description"));
		...
		final ResponseEntity<TmbOneServiceResponse<InstallmentRateResponse>> tmbOneServiceResponseEntity = new ResponseEntity<>(
				installmentRateResponseTmbOneServiceResponse, HttpStatus.OK);
		when(creditCardClient.getInstallmentRate(eq("correlationID"), any(InstallmentRateRequest.class)))
				.thenReturn(tmbOneServiceResponseEntity);
		...
		installmentRateResponseTmbOneServiceResponse1
				.setStatus(new TmbStatus("code", "message", "service", "description"));
		...
		final ResponseEntity<TmbOneServiceResponse<InstallmentRateResponse>> tmbOneServiceResponseEntity1 = new ResponseEntity<>(
				installmentRateResponseTmbOneServiceResponse1, HttpStatus.OK);
		String correlationId = "c83936c284cb398fA46CF16F399C";

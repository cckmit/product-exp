...
public enum AlternativeBuySellSwitchDcaErrorEnums {
    ...
    CUSTOMER_IN_LEVEL_C3_AND_B3("2000002","Customer is in risk level C3 ,B3", AlternativeBuySellSwitchDcaErrorEnums.ERROR_DESC),
    ...
    CANT_BUY_FUND("2000006","Cannot buy the fund", AlternativeBuySellSwitchDcaErrorEnums.ERROR_DESC),

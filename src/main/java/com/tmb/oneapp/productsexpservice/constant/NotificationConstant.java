...
public class NotificationConstant {
	...
	public static final String EMAIL_CARD_ACCOUNT_ID = "fromAcctId";
	public static final String EMAIL_PRODUCT_NAME_TH = "productNameTH";
	public static final String EMAIL_PRODUCT_NAME_EN = "productNameEN";
	public static final String LOCALE_TH = "th";
	public static final String LOCALE_EN = "en";
	public static final String EMAIL_CUSTOMER_NAME_TH = "custFullNameTH";
	public static final String EMAIL_CUSTOMER_NAME_EN = "custFullNameEN";

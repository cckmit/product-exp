...
public class MoneyTransferController {
    ...
    public ResponseEntity<TmbOneServiceResponse<DepositResponse>> cardMoneyTransfer(
        ...
        try {
            ...
            if (!Strings.isNullOrEmpty(toAccountId) && !Strings.isNullOrEmpty(amounts) && !Strings.isNullOrEmpty(expiredDate) &&
                ...
                ResponseEntity<TmbOneServiceResponse<DepositResponse>> tmbOneServiceResponse = creditCardClient.cardMoneyTransfer(correlationId, requestBody);
                ...
                if (response != null && statusCodeValue == 200 && statusCode == HttpStatus.OK) {
                    ...
                    DepositResponse data = response.getData();
     ...
     * @return
     */
    ResponseEntity<TmbOneServiceResponse<DepositResponse>> getTmbOneServiceResponseResponseEntity(HttpHeaders responseHeaders, TmbOneServiceResponse<DepositResponse> serviceResponse) {
